...
void main() async {
  database = await openDatabase(join(await getDatabasesPath(), "ToDoDB.db"),
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: TODOAppUI());
  }
}
...
class _TODOAppUIState extends State<TODOAppUI> {
  ...
  Future<void> showBottomSht(BuildContext context, bool doEdit,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: const Color.fromRGBO(89, 57, 241, 1),
        onPressed: () async {
          await showBottomSht(context, false);
        },
        child: const Icon(
          size: 50,
          Icons.add,
